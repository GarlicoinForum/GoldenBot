...
def grab_chart():
    while True:
        ...
        os.system('chromium --headless --disable-gpu --screenshot "https://bitscreener.com/coins/garlicoin?timeframe=1w&chart_type=candle&chart_unit=usd&is_global=true" --window-size=1920,1080')
        os.system('mv screenshot.png screenshot2.png')
        os.system('chromium --headless --disable-gpu --screenshot "https://bitscreener.com/coins/garlicoin?timeframe=1m&chart_type=candle&chart_unit=usd&is_global=true" --window-size=1920,1080')
        os.system('mv screenshot.png screenshot3.png')
        os.system('chromium --headless --disable-gpu --screenshot "https://bitscreener.com/coins/garlicoin?timeframe=3m&chart_type=candle&chart_unit=usd&is_global=true" --window-size=1920,1080')
